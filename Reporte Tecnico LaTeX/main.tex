...
\parbox{12cm}{
    ...
    % Título del trabajo
    {\large \textbf{Cambiar "Filtro" de detección de catfishing y sextorción en aplicaciones de mensajería basado en PLN mediante refinamiento de un LLM delimitado al geolecto de la Ciudad de México.}}\\[1cm]
...
1er Hipótesis: La implementación de un filtro aplicado en mensajería instantánea para identificación y alertamiento de catfishing y sextorsión podría disminuir en numero los intentos exitosos de estafa.
...
\section{\label{ref-LyA}Limites y alcances}
