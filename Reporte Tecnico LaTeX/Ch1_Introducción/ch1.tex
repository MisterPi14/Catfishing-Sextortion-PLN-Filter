...
El crecimiento exponencial en el uso de tecnologías móviles y plataformas de comunicación digital ha transformado la manera en que interactúan las personas. Según datos de la ENDUTIH 2023 \cite{UsoInternetPorEstado}, en México el 81.2\,\% de la población utiliza teléfono celular y el 96.1\,\% de los usuarios de internet en la Ciudad de México lo hace para comunicarse, principalmente a través de redes sociales y aplicaciones de mensajería. Esta adopción masiva ha traído consigo grandes beneficios, pero también ha abierto nuevas oportunidades para la comisión de delitos como el \textbf{\textit{catfishing}} y la \textbf{\textit{sextorsión}} digital.
...
El presente trabajo concentrará sus esfuerzos, puntualmente, en las estafas \textbf{\textit{catfishing}} y \textbf{\textit{sextorsión}}.
...
citas. Esta combinación los convierte en uno de los grupos con mayor exposición al \textbf{\textit{catfishing}} y a la \textbf{\textit{sextorsión}}.
...
Según la encuesta “Hogares con equipamiento de tecnologías de la información y las comunicaciones, por entidad
federativa, según tipo de tecnología, 2023”, en los hogares de la Ciudad de México se cuenta con los servicios
de internet (89.5 \%) y telefonía (98.9 \%).
...
96.1 \% de las 7,897,062 personas encuestadas en la Ciudad de México utiliza internet para comunicarse; el
90.7 \% lo usa para redes sociales, el 37.7 \% para realizar operaciones bancarias y el 1.3 \% para pagos con tarjetas de
