...
\textbf{NOTA IMPORTANTE: A lo largo del presente reporte se encontrara con terminología escrita en italica, este es un indicador clave que denota estar incluida en la sección "glosario de terminos" en donde encontrspara la definicion de cada palabra.
}\linebreak
...
El presente trabajo concentrara sus esfuerzos sobre las estafas \textbf{\textit{catfishing}} y \textbf{\textit{sextorsión}} puntualmente.
...
citas. Esta combinación los convierte en un grupo con mayor exposición a estafas románticas y \textbf{\textit{catfishing}}
...
96,1 \% de los 7,897,062 de personas encuestadas en la ciudad de México, utilizan el dispositivo móvil para comunicarse, el 90,7 \% para redes sociales, el 37.7 \% para realizar operaciones bancarias, el 1.3 para pagos con tarjetas de
