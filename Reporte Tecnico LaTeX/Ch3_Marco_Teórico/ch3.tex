...
VP (verdaderos positivos): Acontecen cuando tanto la etiqueta verdadera y la predicha por el modelo poseen el valor "verdadero"
FP (falsos positivos): Acontecen cuando la etiqueta verdadera posee el valor "falso" y la predicha por el modelo "verdadero"
VN (verdaderos negativos): Acontecen cuando tanto la etiqueta verdadera y la predicción por el modelo poseen el valor "falso" 
FN (falsos negativos): Acontecen cuando la etiqueta verdadera posee el valor "positivo" y la predicha por el modelo "falso"
