...
Algunas de las metricas que se emplean en la evaluacion de modelos en tareas de clasificacion desde la definicion estan consevidas para clasificacion binaria, algunos ejemplos incluyen la f1 score
...
\subsubsection{F1-Recall o F1-Score}
% ver si f1 recall y f1 score es lo mismo
\cite{f1scoreSkLearn}
