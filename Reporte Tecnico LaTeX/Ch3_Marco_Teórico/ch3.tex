...
El presente proyecto fundamenta el nucleo técnico en la rama del aprendizaje profundo, especificamente se trabajo con modelos largos del lenguaje.
...
Los modelos largos de lenguajes son modelos de aprendizaje profundo que son pre entrenados con grandes cantidades de datos, su función es predecir y generar lenguaje humano a partir de la estimación de probabilidades de que un \textit{token} 
...
artículo Attention Is All You Need en el 2017, este tipo de arquitectura se basa en mecanismos de \textit{atención}. Los transformadores son un conjunto de
...
Los modelos de lenguaje de gran escala (LLMs, por sus siglas en inglés) han transformado la forma en que se abordan las tareas de procesamiento de lenguaje natural (PLN), especialmente en el ámbito de la clasificación de textos. Tradicionalmente, esta tarea dependía de modelos supervisados entrenados con grandes volúmenes de datos etiquetados, los cuales requerían etapas explícitas de extracción de características y entrenamiento. En contraste,

\textbf{los LLMs permiten realizar tareas de clasificación incluso en entornos con pocos o ningún dato etiquetado, a través de técnicas de prompting como lo son zero-shot one-shot y few-shot learning.}
...
El propósito de esta tecnología dentro del presente proyecto se refirio a la definición de la infraestructura como código para el despliegue y la definición de la infraestructura de la propuesta de solución presentada dentro del ecosistema el proveedor de nube de Amazon web services. \cite{WhatIsSLS}
