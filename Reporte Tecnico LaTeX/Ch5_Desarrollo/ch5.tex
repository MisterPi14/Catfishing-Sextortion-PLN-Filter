...
El objetivo de esta etapa fue puntualmente, determinar cuáles eran los patrones clave de cada tipo de estafa: cafishing y la \textbf{\textit{sextorsión}} así como el estilo del lenguaje y la forma de la comunicación que se suele llevar a cabo por parte de los estafadores por un lado para la generación sintética de los datos y para la obtención principalmente de datos reales.
...
El entrándonos en la etapa de la \textbf{\textit{recolección}} de los datos la misma incluida por un lado adentrarnos en el flirt u \textbf{\textit{bot de telegram}} fue necesario realizar el pago para una suscripción del mes, Posteriormente tras acceder a la aplicación se contacto con personas que sugería la aplicacion- Cabe mencionar que en este proceso se identificó una cantidad de interaccion desproporcionada y poco orgánica.

Se estableció un diálogo dentro del mismo grupo que genera el \textbf{\textit{bot de telegram}} el mismo bot advierte sobre no llevarlas a comunicaciones a otro sitio y priorizar establecerlas dentro del grupo creado.
...
1.- \textbf{\textit{Recolección}} y \textbf{\textit{etiquetado de datos}} reales (mayores detalles en la sección “Metodología: Perfil controlado de observación”)
...
3.- \textbf{\textit{Síntesis de datos}} a partir de modelos largos de lenguaje de gran escala, incluyendo modelos como: Cloude Opus 4.6, GPT-5.2, Gemini 3 pro.
4.- Revisión manual de los ejemplos generados priorizando realismo y diversidad
5.- Construcción de conjunto de datos de refinamiento a partir de \textbf{\textit{datos sinteticos}} y conjunto de datos de pruebas a partir de los datos reales.
...
El sistema está diseñado para detectar técnicas de \textbf{\textit{sextorsión}} y \textbf{\textit{catfishing}} en conversaciones de chat, alertando a los usuarios de manera preventiva cuando se identifiquen patrones de riesgo, mientras se cuenta con persistencia de datos y se entrega un sistema de mensajería.
...
La arquitectura es una solución híbrida nube-local diseñada para implementar un sistema de \textbf{\textit{mensajería instantánea}} con caracteristicas de inteligencia artificial para la detección de estafas en modalidad de \textbf{\textit{catfishing}} y/o \textbf{\textit{sextorsión}}. Esta arquitectura se fundamenta en la escalabilidad y confiabilidad de los servicios del \textbf{\textit{ecosistema}} AWS y en el procesamiento local de la \textbf{\textit{inferencia}} de modelos largos de lenguaje (LLMs) como clasificadores. El presente diseño esta contemplado para la deteccion de mensajeria catalogada como \textbf{\textit{catfishing}} o \textbf{\textit{sextorsión}} dentro de conversaciones de chat con el objetivo de alertar a usuarios potencialmente victimas de manera preventiva cuando el sistema identifique patrones de riesgo, todo integrado en un sistema de mensajeria con persistencia de datos y gestion de usuarios.
...
Su uso es requerido dentro del proyecto en alineacion con el objetivo del diseño de un sistema de mnsajeria similar a los medios de redes sociales actuales como WhatsApp o Telegram, en estos casos se emplea una comunicación bidireccional de \textbf{\textit{tiempo sincrono}}, esto se lograra mediante una \textbf{\textit{API}} de tipo \textbf{\textit{WebSocket}} las cuales mantienen una conexion \textbf{\textit{TCP}} persistente que permite comunicacion bidireccional, el servicio de AWS tiene incorporadas caracteristicas propias de los sistemas de comunicación como lo son el manejo de errores y la reconexión, en adición posee la integración con AWS Lambda. 
...
Su uso en el proyecto es fundamental para la implementacion de la logica del \textbf{\textit{backend}}, son requeridas de igual manera para la gestion de la logica de desacoplamiento asincrono gracias a la encolacion desde SQS se consigue que el procesamiento de la \textbf{\textit{inferencia}} del LLM en el worker local sea independiente del flujo de datos principal perteneciente a la funcionalidad del sistema de mensajeria, de esta manera la ejecución del modelo no retraza el envio y recepcion de mensajes, en adicion una de las principales caracteristicas de las funciones lambda es la facturacion la cual puede ser en funcion de las ejecuciones lo cual ahorra costes de \textbf{\textit{aprovisionamiento}} despediciado y solo se cobra por las ejecuciones realizadas.
...
\subsection{Vistas de la aplicacion}
