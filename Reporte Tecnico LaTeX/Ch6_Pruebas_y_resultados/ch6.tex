...
En correspondencia con el objetivo del presente proyeco se efectuo un conjunto de pruebas que involucro desde la creacion de un \textbf{\textit{entorno}} de pruebas funcional descrito en la seccion "Pruebas de \textbf{\textit{desempeño de clasificación}} en LLMs" en el capitulo del desarrollo
